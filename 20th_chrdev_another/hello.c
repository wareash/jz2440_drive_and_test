...
static int hello_open2 (struct inode *inode, struct file *file)
{
	printk("hello_open2\n");
	return 0;
}
...
static struct file_operations hello_fops2 = {
	.owner = THIS_MODULE,
	.open  = hello_open2,
};
...
{		
	...
	cdev_init(&hello_cdv2, &hello_fops2);
	cdev_add(&hello_cdv2, devid, 1);
